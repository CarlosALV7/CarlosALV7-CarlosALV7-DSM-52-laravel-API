                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="fecha_nacimiento" type="date" class="form-control @error('Fecha') is-invalid @enderror" name="email" value="{{ old('fecha_nacimiento') }}" required autocomplete="fecha_nacimiento">
